// Real Bangladesh location data - truncated with essential places
export const bangladeshLocations: Record<string, Record<string, string[]>> = {
  "Dhaka": {
    "Dhaka": ["Dhanmondi", "Gulshan", "Ramna", "Tejgaon", "Wari", "Kotwali", "Lalbagh", "Newmarket", "Paltan", "Shahbagh"],
    "Gazipur": ["Gazipur Sadar", "Kaliakoir", "Kapasia", "Sreepur", "Kaliganj"],
    "Kishoreganj": ["Kishoreganj Sadar", "Bajitpur", "Bhairab", "Hossainpur", "Itna", "Karimganj"],
    "Manikganj": ["Manikganj Sadar", "Ghior", "Harirampur", "Saturia", "Shivalaya", "Singair"],
  ...
  "Chittagong": {
    ...
    "Rangamati": ["Rangamati Sadar", "Baghaichhari", "Barkal", "Belaichhari", "Juraichhari", "Kaptai", "Kawkhali", "Langadu", "Naniyachar", "Rajasthali"]
  },
  "Rajshahi": {
  ...
  "Sylhet": {
    "Sylhet": ["Sylhet Sadar", "Balaganj", "Beanibazar", "Bishwanath", "Companigonj", "Fenchuganj", "Golapganj", "Gowainghat", "Jaintiapur", "Kanaighat", "Osmani Nagar", "Zakiganj"],
  ...
  "Barisal": {
    "Barisal": ["Barisal Sadar", "Agailjhara", "Babuganj", "Bakerganj", "Banari Para", "Gaurnadi", "Hizla", "Mehendiganj", "Muladi", "Wazirpur"],
...
export const getDistrictsForDivision = (division) => {
  return division ? Object.keys(bangladeshLocations[division] || {}) : [];
};

// Helper function to get upazilas for a district
export const getUpazilasForDistrict = (division, district) => {
  return (division && district) ? bangladeshLocations[division]?.[district] || [] : [];
};
